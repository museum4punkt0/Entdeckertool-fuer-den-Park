...
public class Davinci : MonoBehaviour
{
    ...
    private VisualElement targetObj;
    ...
    /// <returns></returns>
    public Davinci into(VisualElement image)
    {
        if (enableLog)
        ...
        switch (rendererType)
        {
            ...
            */
            ...
            case RendererType.uiImage:
                /*
                VisualElement image = targetObj.GetComponent<Image>();
                ...
                */
                ...
                Sprite sprite = Sprite.Create(loadingPlaceholder,
                     new Rect(0, 0, loadingPlaceholder.width, loadingPlaceholder.height),
                     new Vector2(0.5f, 0.5f));
                targetObj.style.backgroundImage = new StyleBackground(sprite);
            ...
            switch (rendererType)
            {
                ...
                */
                ...
                case RendererType.uiImage:
                    ...
                    if (targetObj.style.backgroundImage == null)
                        break;
                    ...
                    maxAlpha = targetObj.style.unityBackgroundImageTintColor.value.a;
