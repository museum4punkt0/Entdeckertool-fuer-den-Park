namespace Mapbox.Examples
{
	...
	public class QuadTreeCameraMovement : MonoBehaviour
	{
		...
		{
			//var zoom = Mathf.Max(5.0f, Mathf.Min(_mapManager.Zoom + zoomFactor * _zoomSpeed, 5.0f));
			var zoom = Mathf.Max(15.0f, Mathf.Min(_mapManager.Zoom + zoomFactor * _zoomSpeed, 17.0f));
