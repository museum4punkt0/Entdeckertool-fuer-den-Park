...
public class GameOverlayWithResults : MonoBehaviour
{
    ...
    public Label Result;
    public VisualElement DetailLink;
    ...
    public void AssignUIElements() {
        ...
        this.Result = root.Q<Label>("RESULT");
        this.DetailLink = root.Q<VisualElement>("DetailActionButton");
    ...
    public void UpdateAndShowGameOverlay(string Headline, string Detail, string ButtonText, bool ShouldExitScene, bool Startgame, string NewSceneName, Sprite sprite, Color color, int Result) {
        ...
        Debug.Log("checking to find result" + this.Result);
        if (this.Result != null) {
            Debug.Log("has results" + Result);
            if (Result != 0) {
                this.Result.text = "" + Result;
                this.Result.style.visibility = Visibility.Visible;
                this.DetailLink.style.visibility = Visibility.Visible;
            } else {
                Debug.Log("knows that result is not over 0" + Result);
                this.DetailLink.style.visibility = Visibility.Hidden;
                this.Result.style.visibility = Visibility.Hidden;
            }
        }
    ...
    void ExitSceneOnButtonPress() {
        ...
        if (this.ShouldExitScene && this.NewSceneName != null) {
